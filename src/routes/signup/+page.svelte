<script lang="ts">
	...
	async function signUp(event: Event) {
		...
		try {
			...
			success = 'Sign-up successful! Check your email for verification.';
		} catch {
...
>
	<div class="shadow-neo w-full max-w-md space-y-8 rounded-3xl bg-white p-8">
		<div class="text-center">
			<h2 class="text-3xl font-extrabold text-gray-900">Create your account</h2>
			<p class="mt-2 text-sm text-gray-600">Join our community and start your journey.</p>
		</div>
		<form class="mt-8 space-y-6" onsubmit={signUp}>
			<div class="space-y-4">
				...
				<div>
					...
					<input
						...
						type="text"
						required
						class="neomorphic-input w-full rounded-3xl px-4 py-3 transition-all focus:outline-none"
				...
				<div class="relative">
					...
					<input
						...
						required
						class="neomorphic-input w-full rounded-3xl px-4 py-3 pr-10 transition-all focus:outline-none"
			...
			<div>
				<button
					type="submit"
					class="neomorphic-button flex w-full justify-center rounded-3xl bg-blue-500 px-4 py-3 text-white transition-all duration-300 hover:bg-blue-600 focus:outline-none"
					disabled={loading}
				>
			...
			<div class="flex space-x-4">
				<button
					...
					class="neomorphic-button flex w-full items-center justify-center rounded-3xl bg-white px-4 py-3 transition-all duration-300 hover:bg-gray-50 focus:outline-none"
				>
					<svg
						width="24"
						height="24"
