<div class="grid h-screen w-auto place-content-center bg-white px-4 dark:bg-gray-900">
    <div class="text-center">
      ...
      <a
        href="/"
        class="mt-6 inline-block rounded bg-indigo-600 px-5 py-3 text-sm font-medium text-black hover:bg-indigo-700 focus:outline-none focus:ring"
      >
        Go Back Home
      </a>
    </div>
